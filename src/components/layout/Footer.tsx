      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-muted-foreground text-sm max-w-sm">
              Free subdomains for everyone. Build your online presence without spending a dime. 
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link to="/abuse" className="hover:text-foreground transition-colors">Report Abuse</Link></li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-border/50 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} M2HGamerz. All rights reserved.
          </p>
